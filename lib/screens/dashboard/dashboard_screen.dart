...
class _DashboardScreenState extends State<DashboardScreen> {
                ...
                children: [
                  ...
                  MedicalCard(
                    ...
                    backgroundColor: appProv.connectedSpreadsheetPath != null
                        ...
                        : AppTheme.warningBg.withValues(alpha: 0.6),
                    border: BorderSide(
                  ...
                  // Main Section: Responsive Stack / Row
                  if (isCompact)
                    Column(
                      children: [
                    ...
                    Row(
                      ...
                      children: [
                        Expanded(
                          flex: 6,
                          child: _buildLowStockPanel(context, appProv, obatProv),
                        ),
  ...
  Widget _buildLowStockPanel(BuildContext context, AppProvider appProv, ObatProvider obatProv) {
    return MedicalCard(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          if (obatProv.lowStockList.isEmpty)
            Container(
              ...
              child: Column(
                children: const [
                  Icon(Icons.check_circle_outline, size: 44, color: AppTheme.emeraldGreen),
                  SizedBox(height: 10),
